...
Global.texture *TexBlock
Global.texture *TexBall
Global.texture *TexRacket
Global.texture *TexPause
...
Procedure.l SDL_init()
  ...
  render=NewRenderer(#title, sdl::#WINDOWPOS_CENTERED, sdl::#WINDOWPOS_CENTERED, #width, #height, 
...
Procedure SDL_quit()
  If *TexBall
    DeleteObject(*TexBall)
  EndIf
  If *TexBlock
    DeleteObject(*TexBlock)
  EndIf
  If *TexRacket
    DeleteObject(*TexRacket)
  EndIf
  If *TexPause
    DeleteObject(*TexPause)
  EndIf
  If Render
    DeleteObject(render)
  EndIf
