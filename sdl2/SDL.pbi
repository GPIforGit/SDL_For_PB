...
;
; Config:
;   Declare a SDL_Config module to change the config and used addons.
...
;   everything is in the module SDL.
; 
...
CompilerIf Not Defined(SDL_Config,#PB_Module)
  DeclareModule SDL_Config
  EndDeclareModule
CompilerEndIf
XIncludeFile "_module_SDL_Config.pbi"
;- DeclareModule _SDL_Config
XIncludeFile "_declare__SDL_Config.pbi"
;- Module _SDL_Config
XIncludeFile "_module__SDL_Config.pbi"
;- DeclareModule SDL
DeclareModule SDL
  ...
  #MAJOR_VERSION=_SDL_Config::#MAJOR_VERSION
  #MINOR_VERSION=_SDL_Config::#MINOR_VERSION
  #PATCHLEVEL=_SDL_Config::#PATCHLEVEL
...
ImportC #SDL2_lib
  ...
  CompilerIf VERSION_ATLEAST(2,0,14)    
    GetErrorMsg.r_utf8(*errstr, maxlen.int) As "SDL_GetErrorMsg"
  CompilerEndIf  
...
ImportC #SDL2_lib
  ...
  CompilerEndIf
  CompilerIf VERSION_ATLEAST(2,0,14)
    SIMDRealloc.r_void(*mem.pvoid, len.size_t) As #FuncPrefix + "SDL_SIMDRealloc"
  CompilerEndIf
  CompilerIf VERSION_ATLEAST(2,0,10)
...
ImportC #SDL2_lib
  ...
  CompilerIf VERSION_ATLEAST(2,0,14)
    HasSurfaceRLE.t_bool(*surface.Surface) As #FuncPrefix + "SDL_HasSurfaceRLE"
  CompilerEndIf  
...
ImportC #SDL2_lib
  ...
  CompilerIf VERSION_ATLEAST(2,0,14)
    JoystickAttachVirtual.int(type.enum, naxes.int, nbuttons.int, nhats.int) As #FuncPrefix + "SDL_JoystickAttachVirtual"
    JoystickDetachVirtual.int(device_index.int) As #FuncPrefix + "SDL_JoystickDetachVirtual"
    JoystickIsVirtual.t_bool(device_index.int) As #FuncPrefix + "SDL_JoystickIsVirtual"
    JoystickSetVirtualAxis.int(*joystick.Joystick, axis.int, value.Sint16) As #FuncPrefix + "SDL_JoystickSetVirtualAxis"
    JoystickSetVirtualButton.int(*joystick.Joystick, button.int, value.Uint8) As #FuncPrefix + "SDL_JoystickSetVirtualButton"
    JoystickSetVirtualHat.int(*joystick.Joystick, hat.int, value.Uint8) As #FuncPrefix + "SDL_JoystickSetVirtualHat"
  CompilerEndIf  
  ...
  CompilerIf VERSION_ATLEAST(2,0,6)
    ...
    CompilerIf VERSION_ATLEAST(2,0,14)
      _JoystickGetSerial.r_utf8(*joystick.Joystick) As #FuncPrefix + "SDL_JoystickGetSerial"
      Macro JoystickGetSerial(joy): SDL::_GetAscii(SDL::_JoystickGetSerial(joy)) :EndMacro
    CompilerEndIf
  ...
  CompilerEndIf
  CompilerIf VERSION_ATLEAST(2,0,14)
    JoystickRumbleTriggers.int(*joystick.Joystick, left_rumble.Uint16, right_rumble.Uint16, duration_ms.Uint32) As #FuncPrefix + "SDL_JoystickRumbleTriggers"
    JoystickHasLED.t_bool(*joystick.Joystick) As #FuncPrefix + "SDL_JoystickHasLED"
    JoystickSetLED.int(*joystick.Joystick, red.Uint8, green.Uint8, blue.Uint8) As #FuncPrefix + "SDL_JoystickSetLED"
  CompilerEndIf
...
CompilerIf VERSION_ATLEAST(2,0,9)
  ...
  ImportC #SDL2_lib    
    CompilerIf VERSION_ATLEAST(2,0,14)
      LockSensors.void() As #FuncPrefix + "SDL_LockSensors"
      UnlockSensors.void() As #FuncPrefix + "SDL_UnlockSensors"
    CompilerEndIf    
...
ImportC #SDL2_lib
  ...
  CompilerEndIf
  CompilerIf VERSION_ATLEAST(2,0,14)
    _GameControllerGetSerial.r_utf8(*gamecontroller.GameController) As #FuncPrefix + "SDL_GameControllerGetSerial"
    Macro GameControllerGetSerial(gamec): sdl::_GetUTF8(sdl::_GameControllerGerSerial(gamec)):EndMacro    
  CompilerEndIf
  ...
  CompilerIf VERSION_ATLEAST(2,0,14)
    GameControllerHasAxis.t_bool(*gamecontroller.GameController, axis.enum) As #FuncPrefix + "SDL_GameControllerHasAxis"
  CompilerEndIf  
  ...
  CompilerIf VERSION_ATLEAST(2,0,14)
    GameControllerHasButton.t_bool(*gamecontroller.GameController, button.enum) As #FuncPrefix + "SDL_GameControllerHasButton"
  CompilerEndIf  
  GameControllerGetButton.Uint8(*gamecontroller.GameController, button.enum) As #FuncPrefix + "SDL_GameControllerGetButton"
  CompilerIf VERSION_ATLEAST(2,0,14)
    GameControllerGetNumTouchpads.int(*gamecontroller.GameController) As #FuncPrefix + "SDL_GameControllerGetNumTouchpads"
    GameControllerGetNumTouchpadFingers.int(*gamecontroller.GameController, touchpad.int) As #FuncPrefix + "SDL_GameControllerGetNumTouchpadFingers"
    GameControllerGetTouchpadFinger.int(*gamecontroller.GameController, touchpad.int, finger.int, *state.pUint8, *x.float, *y.float, *pressure.float) As #FuncPrefix + "SDL_GameControllerGetTouchpadFinger"
    GameControllerHasSensor.t_bool(*gamecontroller.GameController, type.enum) As #FuncPrefix + "SDL_GameControllerHasSensor"
    GameControllerSetSensorEnabled.int(*gamecontroller.GameController, type.enum, enabled.t_bool) As #FuncPrefix + "SDL_GameControllerSetSensorEnabled"
    GameControllerIsSensorEnabled.t_bool(*gamecontroller.GameController, type.enum) As #FuncPrefix + "SDL_GameControllerIsSensorEnabled"
    GameControllerGetSensorData.int(*gamecontroller.GameController, type.enum, *data.float, num_values.int) As #FuncPrefix + "SDL_GameControllerGetSensorData"
  CompilerEndIf    
  CompilerIf VERSION_ATLEAST(2,0,9)
  ...
  CompilerEndIf
  CompilerIf VERSION_ATLEAST(2,0,14)
    GameControllerRumbleTriggers.int(*gamecontroller.GameController, left_rumble.Uint16, right_rumble.Uint16, duration_ms.Uint32) As #FuncPrefix + "SDL_GameControllerRumbleTriggers"
    GameControllerHasLED.t_bool(*gamecontroller.GameController) As #FuncPrefix + "SDL_GameControllerHasLED"
    GameControllerSetLED.int(*gamecontroller.GameController, red.Uint8, green.Uint8, blue.Uint8) As #FuncPrefix + "SDL_GameControllerSetLED"
  CompilerEndIf
...
CompilerIf VERSION_ATLEAST(2,0,14)
  Structure Locale Align #SDLALIGN
    *language.pchar
    *country.pchar
  EndStructure
  Macro r_Locale: i :EndMacro
  ImportC #SDL2_lib
    GetPreferredLocales.r_Locale() As #FuncPrefix + "SDL_GetPreferredLocales"
  EndImport  
CompilerEndIf
;}
;-----------------------
...
CompilerIf VERSION_ATLEAST(2,0,14)
  ImportC #SDL2_lib
    OpenURL.int(url.p-utf8) As #FuncPrefix + "SDL_OpenURL"
  EndImport  
CompilerEndIf
;}
;-----------------------
...
CompilerEndIf
ImportC #SDL2_lib
  _Init.int(flags.Uint32) As #FuncPrefix + "SDL_Init"
...
EndImport
;}
  CompilerIf _SDL_Config::#UseImage
;-----------------------
;- SDL_image.h.pbi
;{
...
;}
  CompilerEndIf
  CompilerIf _SDL_Config::#UseMixer
;-----------------------
;- SDL_mixer.h.pbi
;{
...
Structure ext_Timer
  oldvalue.d
EndStructure
Declare ext_Surface_FlipVertical(*sur.surface)
Declare.d ext_GetElapsedSeconds()
Declare.d ext_DeltaSeconds(*Timer.ext_Timer, max.d = 1.0/15.0)
Declare ext_DeltaDelay(*timer.ext_Timer, delay.d)
;}
EndDeclareModule
;- Module SDL
XIncludeFile "_module_SDL.pbi"
